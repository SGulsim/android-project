...
public final class FragmentForecastBinding implements ViewBinding {
  ...
  private FragmentForecastBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView rvForecast) {
  ...
  public static FragmentForecastBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentForecastBinding((LinearLayout) rootView, rvForecast);
    }
